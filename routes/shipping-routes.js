...
module.exports = function (router) {
  ...
  router.get('/trackshipment2/:trackingNumber', function (req, res) {
    var reqBody = {'tracking' : {'tracking_number': req.params.trackingNumber, 'slug' : ''}};
    var shippingInfo;
    var theSlug = '';
    var theTrackingNumber = req.params.trackingNumber;
